...
class Order(db.Model, BaseModel):
    ...
    # ORDER_STATE_ENUM_DESCRIPTION = ['pending', 'paid', 'delivered', 'completed', 'canceled', 'refunded', 'locked', 'closed']
    ORDER_STATE_ENUM_DESCRIPTION = ['pending', 'paid', 'delivered', 'refunded', 'locked', 'completed']
    ORDER_STATE_ENUM = ['01', '02', '03', '04', '05', '06']
